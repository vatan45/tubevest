                    ...
                    <nav className="hidden md:block">
                        <ul className="flex space-x-8">
                            {['Home', 'Marketplace', 'Create', 'About'].map((item) => (
                                <li key={item}>
                                    <Link
                                        to={item === 'Marketplace' ? '/market' : `/${item.toLowerCase()}`}
                                        className={`text-sm uppercase tracking-wider hover:text-blue-600 transition duration-300 ${scrolled ? 'text-gray-900' : 'text-blue-600'}`}
                                    >
                                        {item}
                                    </Link>
                                </li>
                            ...
                            <ul className="py-4">
                                {['Home', 'Marketplace', 'Create', 'About'].map((item) => (
                                    <li key={item} className="px-4 py-2">
                                        <Link
                                            to={item === 'Marketplace' ? '/market' : `/${item.toLowerCase()}`}
                                            className="block text-sm uppercase tracking-wider hover:text-blue-600 transition duration-300 text-gray-700"
                                        >
                                            {item}
                                        </Link>
                                    </li>
